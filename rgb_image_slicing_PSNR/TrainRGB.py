...
model_dir = 'rgb_image_slicing_SSIM/model'
...
def psnr(y_true, y_pred):
    return 1/((20. * K.log(max_pixel_val)) - (10. * K.log(K.mean(K.square(y_pred - y_true)))))

# Compile model
model.compile(optimizer=Adam(lr=0.001), loss=psnr, metrics=[SSIM, 'mse'])
